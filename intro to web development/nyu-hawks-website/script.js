...
for (var i = 0; i < nonNewsArticleSideNavList.length; i++) {
    nonNewsArticleSideNavList[i].innerHTML =
        '<li><a href="news/2019/04-02-19-events-at-the-nest-3-21-4-6.html">Events at the Nest (3/31/19 - 4/6/19)</a></li>' +
...
for (var j = 0; j < newsArticleSideNavList.length; j++) {
    newsArticleSideNavList[j].innerHTML = 
        '<li><a href="../2019/04-02-19-events-at-the-nest-3-21-4-6.html">Events at the Nest (3/31/19 - 4/6/19)</a></li>' +
