...
for (var i = 0; i < nonNewsArticleSideNavList.length; i++) {
    nonNewsArticleSideNavList[i].innerHTML =
        ...
        '<li><a href="news/2018/10-29-18-hawk-cam-back-online.html">The Hawk Cam is Back Online</a></li>';
};
...
for (var j = 0; j < newsArticleSideNavList.length; j++) {
    newsArticleSideNavList[j].innerHTML = 
        ...
        '<li><a href="../2018/10-29-18-hawk-cam-back-online.html">The Hawk Cam is Back Online</a></li>';
};
